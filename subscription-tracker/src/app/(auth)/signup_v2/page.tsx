    ...
    <div className="min-h-screen bg-muted flex flex-col">
      ...
      <header className="w-full border-b bg-white">
        <div className="container mx-auto flex items-center justify-between py-4 px-6">
          <span className="text-xl font-bold text-primary">PlatformName</span>
          ...
          <Button className="ml-4 px-6 py-2" variant="default">Log In</Button>
        </div>
      </header>
      ...
      <footer className="w-full border-t bg-white mt-auto">
        <div className="container mx-auto flex flex-col md:flex-row items-center justify-between py-4 px-6 text-xs text-muted-foreground">
          <div>© 2023 PlatformName. All rights reserved.</div>
